 ...
 */
package org.anttribe.research.icepdf;
...
public class PageCapture {
    public static void main(String[] args) {
        ...
        String filePath = "D:\\文档API\\Mycat权威指南第一版_V1.0.1.pdf";
    ...
    public class CapturePage implements Callable<Void> {
        ...
        public Void call() {
            ...
            try {
                ...
                String path = "C:\\testFile\\mycat\\";
                File filePath = new File(path);
                if(!filePath.exists()){
                    filePath.mkdir();
                }
                File file = new File(path+"imageCapture_" + pageNumber + ".png");
